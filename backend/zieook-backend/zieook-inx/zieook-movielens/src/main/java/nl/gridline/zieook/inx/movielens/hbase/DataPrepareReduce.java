...
/**
 * Writes rating to sequence file, a rather stuppid reduce.
 * Because we are writing row keys, the output is quite simple and row keys based
 * <p />
 * Project zieook-movielens<br />
 * PreferenceReduce.java created 25 feb. 2011
 * <p />
 * Copyright, all rights reserved 2011 GridLine Amsterdam
 * @author <a href="mailto:job@gridline.nl">Job</a>
 * @version $Revision$, $Date$
 */
public class DataPrepareReduce extends Reducer<ImmutableBytesWritable, Text, Text, Text>
{
