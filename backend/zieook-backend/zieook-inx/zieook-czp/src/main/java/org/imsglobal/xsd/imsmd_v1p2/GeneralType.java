...
@XmlType(name = "generalType", propOrder = {"content"})
public class GeneralType
{

	@XmlElementRefs({
			@XmlElementRef(name = "aggregationlevel", namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2", type = JAXBElement.class),
			...
			@XmlElementRef(name = "structure", namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2", type = JAXBElement.class),
			@XmlElementRef(name = "coverage", namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2", type = JAXBElement.class),
			@XmlElementRef(name = "title", namespace = "http://www.imsglobal.org/xsd/imsmd_v1p2", type = JAXBElement.class),
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link AggregationlevelType }
	 * {@code >} {@link JAXBElement }{@code <}{@link String }{@code >} {@link JAXBElement }{@code <}{@link StructureType }
	 * {@code >} {@link JAXBElement }{@code <}{@link KeywordType }{@code >} {@link JAXBElement }{@code <}
	 * {@link CoverageType }{@code >} {@link JAXBElement }{@code <}{@link TitleType }{@code >} {@link Object }
	 * {@link JAXBElement }{@code <}{@link CatalogentryType }{@code >} {@link String } {@link JAXBElement }{@code <}
	 * {@link String }{@code >} {@link JAXBElement }{@code <}{@link DescriptionType }{@code >}
	 */
