...
/**
 * <p>
 * Java class for contributeType complex type.
 * <p>
...
@XmlType(name = "contributeType", propOrder = {"content"})
public class ContributeType
{
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link RoleType }{@code >}
	 * {@link Object } {@link JAXBElement }{@code <}{@link CentityType }{@code >} {@link String } {@link JAXBElement }{@code <}
	 * {@link DateType }{@code >}
	 */
