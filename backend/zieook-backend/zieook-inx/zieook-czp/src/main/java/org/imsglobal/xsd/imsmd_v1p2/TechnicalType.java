...
/**
 * <p>
 * Java class for technicalType complex type.
 * <p>
...
@XmlType(name = "technicalType", propOrder = {"content"})
public class TechnicalType
{
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link JAXBElement }{@code <}{@link LocationType }{@code >}
	 * {@link Object } {@link JAXBElement }{@code <}{@link String }{@code >} {@link JAXBElement }{@code <}
	 * {@link OtherplatformrequirementsType }{@code >} {@link String } {@link JAXBElement }{@code <}
	 * {@link InstallationremarksType }{@code >} {@link JAXBElement }{@code <}{@link DurationType }{@code >}
	 * {@link JAXBElement }{@code <}{@link RequirementType }{@code >} {@link JAXBElement }{@code <}{@link Integer }{@code >}
	 */
